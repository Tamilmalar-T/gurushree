            ...
            <ul className="navbar-nav ms-auto align-items-center">
              ...
              <li className="nav-item dropdown mx-2">
                ...
                <ul className="dropdown-menu shadow border-0 mt-2" aria-labelledby="specialitiesDropdown">
                  ...
                  <li><Link className="dropdown-item py-2" to="/testing" onClick={collapseNav}>Template 1</Link></li>
                  <li><Link className="dropdown-item py-2" to="/testing2" onClick={collapseNav}>Template 2</Link></li>
                  <li><Link className="dropdown-item py-2" to="/testing3" onClick={collapseNav}>Template 3</Link></li>
                </ul>
              </li>
